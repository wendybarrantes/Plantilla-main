...
})({"4I5bO":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "5c0f59b2dd1442da";
"use strict";
...
async function ValidarEstudiantes(numeroid, clave) {
    ...
    let validar = datos.find((dato)=>dato.numid === numeroid && dato.clave === clave);
    return validar;
}
async function ejecutarValidacion(e) {
    ...
    if (llamarDatos && numeroid.value && clave.value) window.location.href = "formulario.html" // Va el formulario de prestamo
    ;
    else {
...
},{}]},["4I5bO","7BItw"], "7BItw", "parcelRequire6682")

//# sourceMappingURL=inicioSesionEstudiantes.dd1442da.js.map
