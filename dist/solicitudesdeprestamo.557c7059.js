...
})({"41PWb":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "54750e79557c7059";
"use strict";
...
},{}],"9SWd9":[function(require,module,exports) {
var _fetch = require("../servicios/fetch");
const contenedor = document.getElementById("contenedor");
async function cargarSolicitudes() {
    const solicitudes = await (0, _fetch.traerDatos)("solicitudes");
    ...
    solicitudes.forEach((solicitud)=>{
        ...
        infoTitle.textContent = "Solicitud de pr\xe9stamo";
        ...
        btnAceptar.addEventListener("click", async ()=>{
            const infoSolicitud = await (0, _fetch.traerDatosDeUnPermiso)("solicitudes", solicitud.id);
            const historial = {
            ...
            await (0, _fetch.enviarDatos)("historialSolicitudes", historial);
            await (0, _fetch.eliminarSolicitud)("solicitudes", solicitud.id);
            cargarSolicitudes();
        });
...
},{}]},["41PWb","9SWd9"], "9SWd9", "parcelRequire6682")

//# sourceMappingURL=solicitudesdeprestamo.557c7059.js.map
